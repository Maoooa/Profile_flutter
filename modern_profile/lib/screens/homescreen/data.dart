...
// ข้อมูลคอมเมนต์
const List<List<String>> postComments = [
  ['Nice post!', 'Interesting idea!', 'Love this post!'],
  ['Great picture!', 'Love this post!', 'Very beautiful.'],
  ['Very informative.', 'I agree with this.', 'Thanks for sharing.'],
  ['Awesome content!', 'So inspiring.', 'Can relate to this.'],
  ['I like this.', 'This is amazing!', 'Totally agree.'],
  ['Very well done.', 'Great work!', 'Impressive!'],
  ['Nice work!', 'Keep it up.', 'Good job!'],
  ['Fantastic post!', 'Love the topic.', 'Inspiring.'],
];
